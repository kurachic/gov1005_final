...
asset <- asset %>%
  ...
  mutate(val = as.numeric(val), p_val = 0) 

var_names <- list("clownasset", "OwnREH", "num_REH", "ClOwnREH", "desshareREH", "OwnAuto", "num_Auto", "ClOwnAuto", "desshareAuto", "OwnPenAnn", "num_PenAnn", "clownPenAnn", "dessharePenAnn", "OwnBkAcct", "num_BkAcct", "clownBkAcct", "desshareBkAcct", "OwnBus", "num_Bus", "clownBus", "desshareBus", "OwnCC", "num_CC", "clownCC", "desOPCC", "OwnLoan", "num_Loan", "clownLoan", "desOPLoan")

i <- 1

for(i in 1:length(var_names)) {
  asset$p_val[asset$var == var_names[i]] <- t.test(asset$val[asset$var == var_names[i]] ~ asset$filingstatus3[asset$var == var_names[i]], conf.level = 0.95)$p.value
}
